                                 ...
                                 <div class="community-donation__inner mt-60">
                                    ...
                                    <div class="donation-form" data-aos-delay="300">
                                       ...
                                       <div class="donation-form__single">
                                          ...
                                          <div class="radio-wrapper">
                                             <div class="radio-single">
                                                <input type="radio" id="testDonation"
                                             ...
                                             <div class="radio-single">
                                                <input type="radio" id="cardDonation"
                                                   name="donation-payment" checked>
                                                <label for="cardDonation">Credit Card</label>
                                             </div>
                                          </div>
                                    ...
                                    <form action="https://webnextpro.com/tf/charitia/index.html" method="post">
                                       ...
                                       <div class="form-cta">
                                          <button type="submit" aria-label="submit message"
                                             title="submit message" class="btn--secondary"
                                             data-text="Save Informations"><span>Save
                                          Informations</span></button>
                                       </div>
                                    </form>
                                 </div>
                     ...
                     <div class="cm-details__sidebar">
                        <div class="cm-sidebar-widget" data-aos="fade-up" data-aos-duration="1000"
                           ...
                           <form action="#" method="post">
                              <input type="text" name="search-product" id="searchProduct"
                        ...
                        <div class="cm-sidebar-overview" data-aos="fade-up" data-aos-duration="1000"
                           ...
                           <div class="cm-cta">
                              <a href="contact-us.html" aria-label="contact us" title="contact us"
                                 data-text="Get A Quote" class="btn--secondary"> <span>Get A Quote</span>
                              </a>
                           </div>
